...
git branch -M main
git remote add origin git@github.com:tadyated/vidim-cloveka.git
...
```
https://tadyated.github.io/vidim-cloveka/
```
...
python3 scripts/qr_kod.py https://tadyated.github.io/vidim-cloveka/
```
